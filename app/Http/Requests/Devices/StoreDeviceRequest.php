    ...
    public function rules(): array
    {
        return [
            ...
            'device_serial_number' => [
                ...
                'string',
                'max:255',
                Rule::unique('devices', 'device_serial_number')->ignore($this->route('device')),
            ],
            'device_property_number' => [
                'required',
                'string',
                'max:255',
                Rule::unique('devices', 'device_property_number')->ignore($this->route('device')),
            ],
            ...
            'device_deployment_date' => 'nullable|date',
            'end_user_id' => 'nullable|exists:end_users,id',
